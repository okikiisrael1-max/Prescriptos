  ...
  return (
    <div className='flex flex-col items-center justify-center'>
      <form className='border border-gray-300 shadow-md p-8 rounded-lg w-75 md:w-95 mt-10 mb-10'>
        ...
        <p className='mb-4 text-gray-600'>Please login to book appointment</p>
        <div className='mb-4'>
        ...
        <button type='submit' className='w-full bg-indigo-500 text-white py-2 px-4 rounded hover:bg-indigo-700 transition-all'>Login</button>
        <p className='mt-4 text-gray-600 text-[14px] '>Don't have an account? <a href='/signup' className='text-indigo-500 hover:underline'>Sign up here</a></p>
      </form>
      <Footer/>
    </div>
  )
